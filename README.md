...
- `.github/workflows/ci.yaml` builds the app image, pushes to the repo-owned GHCR package (`ghcr.io/<owner>/<repo>`), pushes PR images as `pr-<number>-<headSha>`, and pushes `main` images as `sha-<childSha>`.
