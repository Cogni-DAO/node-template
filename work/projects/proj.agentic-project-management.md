...
| --------------------------------------------------------------------------------- | ----------- | --- | ------------------------ |
| `packages/work-items/` — port interfaces, domain types, status transition table   | Done        | 2   | task.0149                |
| `packages/work-items/` — MarkdownWorkItemAdapter + contract tests                 | In Review   | 3   | task.0151                |
