...
> Source: `work/projects/proj.chain-deployment-refactor.md`
...
Signed repo-spec track extracted from original `docs/spec/chain-config.md` "Long-Term Hardening" section during docs migration. Deployment verification track extracted from `work/projects/proj.chain-deployment-refactor.md`.
