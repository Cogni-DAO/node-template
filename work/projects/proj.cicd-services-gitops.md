...
| 12  | **Canary missing Prometheus metrics** — Alloy running but preview has no Alloy deployed                               | 🟡 IN PR    | —     | k8s Alloy DaemonSet + per-env overlays landing via feat/k8s-alloy-observability; KSM still deferred                                                                                                                                                                                                                                                            |
