...
Agents and app code import `@cogni/work-items` to get typed port interfaces and domain types for work item management — enabling the markdown adapter (task.0156) and skill migration (task.0152) without coupling to any storage backend.
