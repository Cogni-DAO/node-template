...
| 1 | 1 | 1 | needs_implement | bug.0389 | drizzle snapshot chain rot — `db:generate:poly` broken on main; wire `drizzle-kit check` per node | Database Operations | proj.database-ops |
