...
| 1 | 5 | 5 | needs_implement | task.0312 | Agent-first auth Phase 1 — AuthPrincipal + wrapper refactor + actors table | Accounts, API Keys & Wallet Authentication | proj.accounts-api-keys |
