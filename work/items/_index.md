...
| 2 | 50 | 1 | needs_implement | task.0345 | Align buildSha across /readyz, /api/metrics, .well-known/agent.json | Observability Hardening | proj.observability-hardening |
| 2 | 50 | 1 | needs_implement | task.0346 | verify-candidate reads /api/metrics build_info, retires Loki scrape | Observability Hardening | proj.observability-hardening |
...
| 3 | 50 | 1 | needs_implement | task.0347 | Propagate buildSha surface alignment to skill + guide docs | Observability Hardening | proj.observability-hardening |
