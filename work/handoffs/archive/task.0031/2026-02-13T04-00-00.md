...
| `scripts/ci/seed-pnpm-store.sh`                                 | Deploy wrapper (pulls GHCR, delegates to core script) |
...
| `infra/compose/docker-compose.dev.yml:523`                      | Gateway compose — tmpfs, volumes, env                 |
