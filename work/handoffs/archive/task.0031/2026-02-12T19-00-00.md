...
| `infra/compose/docker-compose.dev.yml`             | Dev compose — gateway service + pnpm_store volume              |
| `infra/compose/docker-compose.yml`                 | Prod compose — GHCR image ref + same volume                    |
