...
| `infra/compose/configs/litellm.config.yaml`                         | Add `generic_api` to `success_callback`                                             |
| `infra/compose/docker-compose.dev.yml`                              | Add `GENERIC_LOGGER_ENDPOINT` + `GENERIC_LOGGER_HEADERS` to litellm                 |
