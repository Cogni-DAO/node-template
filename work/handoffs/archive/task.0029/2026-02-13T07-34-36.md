...
| `infra/compose/configs/litellm.config.yaml`                         | LiteLLM config — add `generic_api` to `success_callback`                           |
| `infra/compose/docker-compose.dev.yml:111-133`                      | LiteLLM container — add `GENERIC_LOGGER_ENDPOINT` env var                          |
