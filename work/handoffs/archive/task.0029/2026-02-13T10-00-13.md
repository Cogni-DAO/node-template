...
| `infra/compose/configs/litellm.config.yaml`                         | Add `generic_api` to `success_callback` (not yet done)                              |
| `infra/compose/docker-compose.dev.yml`                              | Add env vars to litellm + app services (not yet done)                               |
| `infra/compose/docker-compose.yml`                                  | Same for prod compose (not yet done)                                                |
