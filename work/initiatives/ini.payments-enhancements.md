...
Content aggregated from original `docs/BILLING_EVOLUTION.md` (Known Issues + Future Work), `docs/spec/external-executor-billing.md` (P0 remaining + P1 hardening), and `docs/DAO_ENFORCEMENT.md` (Section 5: future DAO hardening) during docs migration.
