 ...
 *   difference — since getSessionUser imports resolveRequestIdentity
 *   (via @/app/_lib/auth/session), the ai/runs handler already accepts
 *   machine bearer tokens. This file exists solely to keep the agent-first
 *   URL contract stable.
