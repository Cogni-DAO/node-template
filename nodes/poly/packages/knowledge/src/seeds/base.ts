/**
 * Module: `@cogni/poly-knowledge/seeds/base`
 * Purpose: Base knowledge seeds. Inlined from the former
 *   `@cogni/node-template-knowledge` package (deleted in repo split).
...
/**
 * Base knowledge seeds — generic domain knowledge inherited at provisioning
 * time. Poly-specific seeds extend this list in `seeds/poly.ts`.
 */
