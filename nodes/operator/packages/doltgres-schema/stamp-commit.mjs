...
// working set per dolthub/dolt#4843. Runs inside the operator migrator image
// immediately after `drizzle-kit migrate` (see package.json
// db:migrate:operator:doltgres:container). Tolerates only the idempotent
...
//
// Ships as part of @cogni/operator-doltgres-schema (copied in full by the
// operator migrator Dockerfile). Not tree-shaken by tsup because it's not an
// entry.
