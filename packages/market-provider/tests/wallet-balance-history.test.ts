    ...
    const history = mapWalletBalanceHistory({
      ...
      trades: [
        {
          ...
          size: 100,
          price: 0.4,
          timestamp: 1_776_758_400, // 2026-04-20T08:00:00Z
        } as never,
        {
          asset: "asset-yes",
          side: "SELL",
          size: 50,
          price: 0.6,
          timestamp: 1_776_844_800, // 2026-04-21T08:00:00Z
        } as never,
      ],
      priceHistoryByAsset: new Map([
        [
          "asset-yes",
          [
            { t: 1_776_700_800, p: 0.4 }, // 2026-04-19T16:00:00Z
            { t: 1_776_787_200, p: 0.6 }, // 2026-04-20T16:00:00Z
            { t: 1_776_873_600, p: 0.5 }, // 2026-04-21T16:00:00Z
          ],
        ],
      ]),
    });
