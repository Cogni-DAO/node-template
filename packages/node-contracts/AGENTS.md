...
- `poly.wallet.overview.v1.contract` — `GET /api/v1/poly/wallet/overview`; current tenant wallet snapshot for the dashboard: address, POL gas, available USDC.e, locked open-order notional, position MTM, total, open-order count, warnings.
