...
/**
 * Module: `@e2e/smoke/a11y-docs`
 * Purpose: Automated accessibility testing for docs page using axe-core WCAG validation.
 * Scope: Tests docs page against wcag2a/wcag2aa standards. Does not test interactive behavior or forms.
...
test("[smoke] docs passes axe core checks", async ({ page }) => {
