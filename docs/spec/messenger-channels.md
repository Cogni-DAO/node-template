...
| Rule                         | Constraint                                                                                                                                                                                                                                                                                                               |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| MESSENGER_BILLING_VIA_PROXY  | Messenger conversations are billed via the same LLM proxy audit log as sandbox execution. OpenClaw's agent calls LLM through `llm-proxy-openclaw:8080` with billing headers. The proxy injects `x-litellm-end-user-id` from the OpenClaw session's `outboundHeaders`. No separate billing path for messenger vs sandbox. |
