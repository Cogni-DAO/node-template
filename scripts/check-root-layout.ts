...
const REQUIRED_PATHS: PathRequirement[] = [
  ...
  { anyOf: ["apps/web/src/app"], kind: "dir" },
  { anyOf: ["apps/web/src/features"], kind: "dir" },
  { anyOf: ["apps/web/src/ports"], kind: "dir" },
  { anyOf: ["apps/web/src/core"], kind: "dir" },
  { anyOf: ["apps/web/src/adapters/server"], kind: "dir" },
