...
const REQUIRED_PATHS: PathRequirement[] = [
  ...
  { anyOf: ["nodes/node-template/app/src/app"], kind: "dir" },
  { anyOf: ["nodes/node-template/app/src/features"], kind: "dir" },
  { anyOf: ["nodes/node-template/app/src/ports"], kind: "dir" },
  { anyOf: ["nodes/node-template/app/src/core"], kind: "dir" },
  { anyOf: ["nodes/node-template/app/src/adapters/server"], kind: "dir" },
  { anyOf: ["nodes/node-template/app/src/shared"], kind: "dir" },
  { anyOf: ["nodes/node-template/app/src/bootstrap"], kind: "dir" },
  { anyOf: ["nodes/node-template/app/public"], kind: "dir" },
