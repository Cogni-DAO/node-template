 ...
 * Scope: Local check orchestration only; does not replace full canary/main package builds or CI validation.
...
if (
  !upstreamRef &&
  gitOk(["show-ref", "--verify", "--quiet", "refs/remotes/origin/canary"])
) {
  upstreamRef = "origin/canary";
}
