 ...
 * Scope: Server-only helpers; reads versioned config and exposes node identity, typed payment config, and governance schedule config; does not expose env overrides or client-facing APIs.
