 ...
 * Purpose: Top bar for authenticated app pages with sidebar trigger, treasury, socials, and wallet.
 * Scope: Renders top bar within SidebarInset. Does not handle authentication or sidebar state.
 * Invariants: SidebarTrigger requires SidebarProvider ancestor; socials visible lg+ only.
 * Side-effects: none
...
import { GithubButton, ModeToggle, SidebarTrigger } from "@/components";
