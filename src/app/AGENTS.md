...
- **Routes (if any):**
  - App pages: `/` (homepage)
  - API: `/api/v1/meta/health`, `/api/v1/meta/openapi`, `/api/v1/meta/route-manifest`, `/api/v1/ai/completion`, `/api/admin/accounts/register-litellm-key`, `/api/admin/accounts/[accountId]/credits/topup`
- **CLI (if any):** none
