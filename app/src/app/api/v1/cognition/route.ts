 ...
 *   agent). Reads via container.knowledgeStorePort. Index-first — skill/domain bodies stay behind the same authed read routes
 *   (KNOWLEDGE_READ_REQUIRES_PRINCIPAL); the current-node orientation entry is
 *   the one exception, rendered in full.
